...
def cmd_compare(args, df, idle):
    ...
    windows = [('全样本 2018-', '2018-01-01', None),
               ('训练 2018-22', '2018-01-01', '2022-12-31'),
               ('测试 2023-26', '2023-01-01', None)]
    ...
    print('\n[4] 起点敏感度 (不同起始年全样本年化%)')
    rows = []
    for start in ['2016-01-01', '2017-01-01', '2018-01-01', '2019-01-01', '2020-01-01']:
...
def main():
    ...
    w.add_argument('--start', default='2018-01-01', help='首个测试年起点')
